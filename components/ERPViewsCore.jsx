    ...
    <div style={styles.card}>
      ...
      <form onSubmit={handleCreateInvoice}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
          ...
          <div><label style={styles.label}>Fare Type</label><select value={invForm.refundable} onChange={e => setInvForm({...invForm, refundable: e.target.value})} style={
