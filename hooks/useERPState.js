...
const en = {
  ...
  noInvoices:'No Invoices Found', createFirst:'Create an invoice to get started!',
  allStatus:'All Status', paid:'Paid', unpaid:'Unpaid', totalInvoices:'Total Invoices',
  totalRevenue:'Total Revenue', outstanding:'Outstanding', netPosition:'Net Position',
  portalBalance:'Portal Balance', totalCustomers:'Total Customers', quickActions:'Quick Actions',
  viewInvoices:'View Invoices', attendance:'Attendance', recentInvoices:'Recent Invoices',
  date:'Date', customer:'Customer', name:'Name', phone:'Phone', type:'Type',
  creditBal:'Credit Balance', creditLimit:'Credit Limit', vatNo:'VAT No', address:'Address',
  price:'Price', duration:'Duration', inclusions:'Inclusions', location:'Location', manager:'Manager',
  email:'Email', timing:'Timing', role:'Role', salary:'Salary', commissionPct:'Commission %',
  iqama:'IQAMA', description:'Description', payment:'Payment', amount:'Amount',
  from:'From', to:'To', note:'Note', transfer:'Transfer', fundTransfer:'Fund Transfer',
  dateTime:'Date/Time', user:'User', action:'Action', searchLogs:'Search logs...',
  addUser:'+ Add User', editUser:'Edit User', username:'Username',
  linkEmployee:'Link to Employee', permissions:'Permissions', admin:'Admin',
  invoices:'Invoices', bank:'Bank', reports:'Reports', settings:'Settings',
  saveChanges:'Save Changes', cancel:'Cancel', cancelEdit:'Cancel Edit',
  none:'— None —', newCustomer:'+ New Customer', customerName:'Customer Name',
  ...
  returnFlight:'Return', multiCity:'Multi-City',
  sectorPlaceholder:'Sector (e.g. RUH-JED)', refundable:'Refundable', nonRefundable:'Non-Refundable',
  ticketStatus:'Ticket Status', confirmed:'Confirmed', onHold:'On Hold', cancelled:'Cancelled',
  pricing:'Pricing', qty:'Qty', costUnit:'Cost / unit (SAR)', sellUnit:'Sell / unit (SAR)',
  discountSAR:'Discount (SAR)', vatPct:'VAT Rate %', sellAfterDisc:'Sell (after disc.)',
  vat:'VAT', grandTotal:'Grand Total', profit:'Profit', dueAfterPaid:'Due After Paid',
  amountPaidNow:'Amount Paid Now (SAR)', creditDueDate:'Credit Due Date', creditor:'Creditor',
  useCredit:'Use Credit (SAR)', available:'available', exceedsCredit:'⚠️ Exceeds available credit balance',
  useMaxAvailable:'Use max available', tabbyOrderNo:'Tabby Order No.', tamaraOrderNo:'Tamara Order No.',
  today:'Today', checkIn:'Check-In', checkOut:'Check-Out', notMarked:'Not marked',
  checkInAt:'Checked in at', checkOutAt:'Checked out at',
  requestLeave:'Request Leave', leaveType:'Leave Type', annual:'Annual',
  sick:'Sick', emergency:'Emergency', unpaidLeave:'Unpaid', leaveTo:'To',
  submitRequest:'Submit Request', history:'History', last60:'History (last 60)',
  loading:'Loading…', noAttendance:'No attendance records yet.',
  ...
  payrollSlips:'Payroll & Slips', addEmployee:'+ Add Employee', editEmployee:'Edit Employee',
  fullName:'Full Name', jobTitle:'Job Title', nationality:'Nationality',
  nationalId:'National ID / Iqama No.', iqamaExpiry:'Iqama Expiry',
  maktabAmal:'Labor Office Renewal Date', joinDate:'Join Date',
  salarySAR:'Salary (SAR)', bankName:'Bank Name', bankAccount:'Bank Account / IBAN',
  newAdvance:'+ New Advance', advanceStatus:'Status', pending:'Pending',
  repaid:'Repaid', deductedFromSalary:'Deducted from Salary', addAdvance:'Add Advance',
  ...
  searchEmployees:'Search employees...', totalExpenses:'Total Expenses', count:'Count',
  totalRefunds:'Total Refunds', refundedToCustomers:'Refunded to Customers',
  ...
  oldTicket:'Old ticket', originalPrice:'Original price', refundedToCustomer:'Refunded to customer',
  companyKept:'company kept', linkedReason:'Reason',
  invoiceDesign:'Invoice Design', professionalInvoice:'Professional Invoice',
  ...
  prev:'Prev', next:'Next', noData:'No data found', backToDashboard:'Back to Dashboard',
  pageUnderDev:'Page Under Development', totalPaid:'Total Paid', totalDue:'Total Due',
  totalProfit:'Total Profit', unpaidInvoices:'Unpaid Invoices', netProfit:'Net Profit',
  ...
  locationCol:'Location', managerCol:'Manager', emailCol:'Email', timingCol:'Timing',
  salaryCol:'Salary', commissionCol:'Commission %', iqamaCol:'IQAMA',
  titleCol:'Title', expiryCol:'Expiry', maktabCol:'Maktab Amal',
  dateCol:'Date', typeCol:'Type', descCol:'Description',
  paymentCol:'Payment', amountCol:'Amount',
  ...
  permsCol:'Permissions', nameCol:'Name', phoneCol:'Phone',
  balanceCol:'Balance', currentOutstandingCol:'Current Outstanding',
  limitCol:'Credit Limit', actionCol:'Action',
  vendorCol:'Vendor', phoneCol:'Phone', balanceDueCol:'Balance Due',
  empCol:'Employee', dateCol:'Date', amountCol:'Amount', statusCol:'Status',
  ...
  storeCreditMsg:'available',
  exceedsMsg:'⚠️ Exceeds available credit balance',
  useMaxBtn:'Use max available',
  reqDateCol:'Date', custRefundCol:'Cust Refund', portalRefundCol:'Portal Refund',
  origInvCol:'Original Inv', reasonCol:'Reason',
  refundToCustCol:'Refunded to Customers', refundToPortCol:'Refunded to Portals',
  refundCountCol:'Total Refunds',
  expenseDateCol:'Date', expenseTypeCol:'Type', expenseDescCol:'Description',
  expensePaymentCol:'Payment',
  cashInCol:'Cash In', cashOutCol:'Cash Out',
  bankInCol:'Bank In', bankOutCol:'Bank Out', investorInCol:'Investor In',
  investorOutCol:'Investor Out',
  transTypeCol:'Type', transDescCol:'Description', transAmountCol:'Amount',
  totalRefundsCol:'Total Refunds', refundDateCol:'Date', refundCustCol:'Customer',
  refundAirlineCol:'Airline', refundPnrCol:'PNR', refundReasonCol:'Reason',
  refundCustAmtCol:'Cust Refund', refundPortalAmtCol:'Portal Refund',
  refundOrigAmtCol:'Original Inv',
  totalExpAmtCol:'Total Expenses', expCountCol:'Count',
  totalPortalsCol:'Total Portals', portalNameCol:'Name',
  portalTypeCol:'Type', portalBalCol:'Balance',
  pkgNameCol:'Name', pkgPriceCol:'Price', pkgDurationCol:'Duration', pkgInclusionsCol:'Inclusions',
  branchNameCol:'Name', branchLocCol:'Location', branchPhoneCol:'Phone',
  branchMgrCol:'Manager', branchEmailCol:'Email', branchTimingCol:'Timing',
  hrNameCol:'Name', hrRoleCol:'Role', hrPhoneCol:'Phone',
  hrSalaryCol:'Salary', hrCommCol:'Commission %', hrIqamaCol:'IQAMA',
  userEmpCol:'Linked Employee', userPermsCol:'Permissions',
  permAdmin:'Admin', permInvoices:'Invoices', permBank:'Bank',
  permHR:'HR', permReports:'Reports', permSettings:'Settings',
  emailDisabled:'(cannot change)', createBtn:'+ Create Invoice',
  noInvoicesMsg:'No invoices yet. Create your first invoice!',
  noRefundsMsg:'No refunds found. Click the refund button on any invoice to create one!',
  noCustomersMsg:'No customers found.', noCorporatesMsg:'No corporates found.',
  noVendorsMsg:'No vendors found.', noCreditorsMsg:'No creditors found.',
  noPortalsMsg:'No portals found.', noPackagesMsg:'No packages found.',
  noBranchesMsg:'No branches found.', noEmployeesMsg:'No employees found.',
  noExpensesMsg:'No expenses found.', noLogsMsg:'No logs found.',
  noUsersMsg:'No users found.', noMistakesMsg:'No mistakes logged yet.',
  noAdvancesMsg:'No pending advances.', noPayrollMsg:'No salary paid yet.',
  noAttMsg:'No attendance records yet.',
  noPortalsBalMsg:'No portals added yet.',
  linkedBookingTitle:'🔗 Previous Booking / Store Credit',
  bookingInfoTitle:'📅 Booking Info',
  serviceDetailsTitle:'🛫 Service Details',
  pricingTitle:'💰 Pricing',
  paymentTitle:'💳 Payment',
  todayTitle:'Today',
  leaveReqTitle:'Request Leave',
  historyTitle:'History (last 60)',
  directoryTitle:'👤 Directory',
  advancesTitle:'💵 Advances',
  mistakesTitle:'⚠️ Mistakes/Deductions',
  payrollTitle:'🧾 Payroll & Slips',
  addEmpTitle:'+ Add Employee',
  editEmpTitle:'Edit Employee',
  newAdvTitle:'+ New Advance / Loan',
  advancesTableTitle:'Pending Advances',
  mistakesTableTitle:'Mistake History',
  payrollTableTitle:'Salary Slip History',
  invNoShort:'Inv No', pax:'Pax',
  paidLabel:'Paid', dueLabel:'Due',
  profitLabel:'Profit', profitAmtLabel:'Profit',
  costLabel:'Cost', sellLabel:'Sell',
  vatLabel:'VAT', grandTotalLabel:'Grand Total',
  dueAfterPaidLabel:'Due After Paid',
  cancelEditBtn:'✕ Cancel Edit',
  generateInvBtn:'✅ Generate Invoice',
  updateInvBtn:'💾 Update Invoice',
  checkInBtn:'🟢 Check In',
  checkOutBtn:'🔴 Check Out',
  submitLeaveBtn:'Submit Request',
  ...
  previewBtn:'👁',
  quickSettleBtn:'💰',
  createRefundBtn:'Create Refund',
  convertToInvBtn:'Convert to Invoice',
  approveBtn:'Approve',
  rejectBtn:'Reject',
  returnedBtn:'Returned',
  deductFromSalary:'Deducted from Salary',
  suspendBtn:'⏸ Suspend',
  activateBtn:'▶ Activate',
  deleteBtnShort:'Delete',
  createAgencyBtn:'🚀 Create Agency & Generate Password',
  createQuoteBtn:'Generate Quotation',
  payBtn:'Pay',
  logLossBtn:'Log Loss',
  rechargeBtn:'Recharge',
  createRecurringBtn:'Create',
  downloadSlipBtn:'Download Slip',
  previewSlipBtn:'Preview Slip',
  editLimitBtn:'Edit Limit',
  saveLimitBtn:'Save',
  exportBankBtn:'📥 Export Bank Statement',
  exportCashBtn:'📥 Export Cash Statement',
  exportMistakesBtn:'Export Excel',
  exportRefundBtn:'Export Excel',
  exportVendorsBtn:'Export Excel',
  exportPackagesBtn:'Export Excel',
  exportBranchesBtn:'Export Excel',
  exportPortalsBtn:'Export Excel',
  exportPayrollBtn:'Export Excel',
  exportInvestmentsBtn:'Export Excel',
  exportCashbookBtn:'Export Excel',
  searchPlaceholder:'Search...',
  dateFilterPlaceholder:'Filter by date',
  invNoPlaceholder:'Search by invoice #, customer, airline, PNR...',
  refundPlaceholder:'Search refunds...',
  customerPlaceholder:'Search customers...',
  corporatePlaceholder:'Search corporates...',
  vendorPlaceholder:'Search vendors...',
  creditorPlaceholder:'Search...',
  packagePlaceholder:'Search packages...',
  branchPlaceholder:'Search branches...',
  employeePlaceholder:'Search employees...',
  expensePlaceholder:'Search expenses...',
  ...
  agencyNamePlaceholder:'Agency Name (English) *',
  companyNameArPlaceholder:'Company Name (Arabic)',
  ownerEmailPlaceholder:'Owner Email *',
  subEndDatePlaceholder:'Subscription End Date *',
  vatNoPlaceholder:'VAT Number',
  crNoPlaceholder:'CR Number',
  locationPlaceholder:'Location',
  managerPlaceholder:'Manager',
  timingPlaceholder:'Timing',
  jobTitlePlaceholder:'Job Title',
  nationalityPlaceholder:'Nationality',
  iqamaNoPlaceholder:'Iqama No',
  bankNamePlaceholder:'Bank Name',
  bankAccountPlaceholder:'Bank Account / IBAN',
  salaryPlaceholder:'Base Salary',
  commissionPlaceholder:'Commission %',
  roleName:'Role',
  customerTypeRole:'Customer Type',
  individualRole:'Individual',
  corporateRole:'Corporate',
  serviceRole:'Service',
  flightTicketRole:'Flight Ticket',
  hotelRole:'Hotel',
  visaRole:'Visa',
  packageRole:'Package',
  otherRole:'Other',
  flightTypeRole:'Flight Type',
  domesticRole:'Domestic',
  internationalRole:'International',
  journeyRole:'Journey',
  singleRole:'Single',
  returnRole:'Return',
  multiCityRole:'Multi-City',
  bookingTypeRole:'Booking Type',
  newBookingRole:'New Booking',
  reissueRole:'Reissue',
  dateChangeRole:'Date Change',
  voidRole:'Void',
  paymentRole:'Payment Method',
  cashRole:'Cash',
  bankTransferRole:'Bank Transfer',
  cardRole:'Card / Network',
  creditRole:'Credit',
  creditBalanceRole:'Credit Balance',
  tabbyRole:'Tabby',
  tamaraRole:'Tamara',
  ticketStatusRole:'Ticket Status',
  confirmedRole:'Confirmed',
  onHoldRole:'On Hold',
  cancelledRole:'Cancelled',
  refundableRole:'Refundable',
  nonRefundableRole:'Non-Refundable',
  visaTypeRole:'Visa Type',
  touristRole:'Tourist',
  businessRole:'Business',
  workRole:'Work',
  transitRole:'Transit',
  leaveTypeRole:'Leave Type',
  annualRole:'Annual',
  sickRole:'Sick',
  emergencyRole:'Emergency',
  unpaidLeaveRole:'Unpaid',
  advanceStatusRole:'Advance Status',
  pendingRole:'Pending',
  repaidRole:'Repaid',
  deductedFromSalaryRole:'Deducted from Salary',
  expenseApprovalRole:'Expense Approval',
  approvalStatusRole:'Approval Status',
  ...
  recurringIntervalRole:'Interval',
  monthlyRole:'Monthly',
  yearlyRole:'Yearly',
  weeklyRole:'Weekly',
  customerRole:'Customer',
  amountRole:'Amount (SAR)',
  intervalRole:'Interval',
  profilePicRole:'Update Profile Picture',
  usernameRole:'Username',
  phoneNumberRole:'Phone Number',
  addressFieldRole:'Address',
  saveProfileBtn:'💾 Save Profile Changes',
  changePasswordTitle:'🔒 Security',
  newPasswordRole:'New Password',
  ...
  airlineServiceCol:'Airline / Service',
  ticketsSoldCol:'Tickets Sold',
  totalRevCol:'Total Revenue',
  totalCostCol:'Total Cost',
  netProfitCol:'Net Profit',
  noInvoiceData:'No invoice data available. Create invoices to see profitability analysis.',
  ...
  customerRefundCol:'Customer Refund',
  officeEarned:'Office Earned',
  ...
  txnDateCol:'Date',
  txnInvNoCol:'Invoice No',
  txnDebitCol:'Debit (Inv)',
  txnCreditCol:'Credit (Paid)',
  txnBalanceCol:'Balance',
  downloadStatementBtn:'Download Statement',
  noTxnFound:'No transactions found.',
  recurringInvoicesTitle:'🔁 Recurring Invoices',
  setupRecurringTitle:'Setup Recurring Profile',
  customerLabel:'Customer',
  amountLabel:'Amount (SAR)',
  intervalLabel:'Interval',
  createBtn:'Create',
  profileIdCol:'Profile ID',
  ...
  oldTicketNoLabel:'Old Ticket No',
  newTicketNoLabel:'New Ticket No',
  lossAmountLabel:'Loss Amount (SAR)',
  deductFromSalaryLabel:'Deduct from Salary',
  logLossBtn:'Log Loss',
  mistakeHistoryTitle:'Mistake History',
  dateCol:'Date',
  employeeCol:'Employee',
  oldTicketCol:'Old Ticket',
  newTicketCol:'New Ticket',
  lossAmountCol:'Loss Amount',
  salaryDeductedCol:'Salary Deducted',
  yesLabel:'Yes',
  noLabel:'No',
  ...
  otNote:'Overtime after 9 hours',
  deductionNote:'Salary Deduction if less than 8 hours',
  attendanceHistoryTitle:'Attendance History',
  checkInCol:'Check-In',
  checkOutCol:'Check-Out',
  overtimeCol:'Overtime',
  deductionCol:'Deduction',
  noAttendanceHistory:'No attendance marked yet.',
  ...
  actionCol:'Action',
  downloadSlipBtn:'Download Slip',
  noSalaryPaid:'No salary paid yet.',
  ...
  recurringInvoicesTitle:'🔁 Recurring Invoices',
  expenseApprovalTitle:'🛡️ Expense Approval',
...
const ar = {
  ...
  noInvoices:'لا توجد فواتير', createFirst:'أنشئ فاتورة للبدء!',
  allStatus:'جميع الحالات', paid:'مدفوعة', unpaid:'غير مدفوعة', totalInvoices:'إجمالي الفواتير',
  totalRevenue:'إجمالي الإيرادات', outstanding:'المستحق', netPosition:'الصافي',
  portalBalance:'رصيد البوابات', totalCustomers:'إجمالي العملاء', quickActions:'إجراءات سريعة',
  viewInvoices:'عرض الفواتير', attendance:'الحضور', recentInvoices:'الفواتير الأخيرة',
  date:'التاريخ', customer:'العميل', name:'الاسم', phone:'الهاتف', type:'النوع',
  creditBal:'رصيد مستحق', creditLimit:'حد الائتمان', vatNo:'الرقم الضريبي', address:'العنوان',
  price:'السعر', duration:'المدة', inclusions:'يشمل', location:'الموقع', manager:'المدير',
  email:'البريد', timing:'المواعيد', role:'الدور', salary:'الراتب', commissionPct:'نسبة العمولة %',
  iqama:'الإقامة', description:'الوصف', payment:'الدفع', amount:'المبلغ',
  from:'من', to:'إلى', note:'ملاحظة', transfer:'تحويل', fundTransfer:'تحويل أموال',
  dateTime:'التاريخ/الوقت', user:'المستخدم', action:'الإجراء', searchLogs:'بحث في السجلات...',
  addUser:'+ إضافة مستخدم', editUser:'تعديل المستخدم', username:'اسم المستخدم',
  linkEmployee:'ربط بموظف', permissions:'الصلاحيات', admin:'مدير',
  invoices:'الفواتير', bank:'البنك', reports:'التقارير', settings:'الإعدادات',
  saveChanges:'حفظ التغييرات', cancel:'إلغاء', cancelEdit:'إلغاء التعديل',
  none:'— لا يوجد —', newCustomer:'+ عميل جديد', customerName:'اسم العميل',
  ...
  sectorPlaceholder:'القطاع (مثل: الرياض-جدة)', refundable:'قابل للاسترجاع', nonRefundable:'غير قابل للاسترجاع',
  ticketStatus:'حالة التذكرة', confirmed:'مؤكد', onHold:'معلق', cancelled:'ملغي',
  pricing:'التسعير', qty:'الكمية', costUnit:'التكلفة / وحدة (ريال)', sellUnit:'البيع / وحدة (ريال)',
  discountSAR:'الخصم (ريال)', vatPct:'نسبة الضريبة %', sellAfterDisc:'البيع (بعد الخصم)',
  vat:'الضريبة', grandTotal:'الإجمالي', profit:'الربح', dueAfterPaid:'المتبقي بعد الدفع',
  amountPaidNow:'المبلغ المدفوع الآن (ريال)', creditDueDate:'تاريخ الاستحقاق', creditor:'الدائن',
  useCredit:'استخدام الرصيد (ريال)', available:'متاح', exceedsCredit:'⚠️ يتجاوز الرصيد المتاح',
  useMaxAvailable:'استخدم الحد الأقصى المتاح', tabbyOrderNo:'رقم طلب تابي', tamaraOrderNo:'رقم طلب تمارة',
  today:'اليوم', checkIn:'تسجيل الحضور', checkOut:'تسجيل الانصراف', notMarked:'لم يسجل',
  checkInAt:'تم تسجيل الحضور في', checkOutAt:'تم تسجيل الانصراف في',
  requestLeave:'طلب إجازة', leaveType:'نوع الإجازة', annual:'سنوية',
  sick:'مرضية', emergency:'طوارئ', unpaidLeave:'بدون راتب', leaveTo:'إلى',
  submitRequest:'تقديم الطلب', history:'السجل', last60:'السجل (آخر 60)',
  loading:'جاري التحميل…', noAttendance:'لا توجد سجلات حضور بعد.',
  accountNotLinked:'الحساب غير مربوط',
  accountNotLinkedMsg:'حسابك غير مربط بسجل موظف بعد. اطلب من المدير تعيين employee_id في المستخدمين.',
  directory:'الدليل', advances:'السلف', mistakesDeductions:'الأخطاء/الخصومات',
  payrollSlips:'الرواتب وقسائم الدفع', addEmployee:'+ إضافة موظف', editEmployee:'تعديل الموظف',
  fullName:'الاسم الكامل', jobTitle:'المسمى الوظيفي', nationality:'الجنسية',
  nationalId:'رقم الهوية / رقم الإقامة', iqamaExpiry:'انتهاء الإقامة',
  maktabAmal:'تاريخ تجديد مكتب العمل', joinDate:'تاريخ الالتحاق',
  salarySAR:'الراتب (ريال)', bankName:'اسم البنك', bankAccount:'الحساب البنكي / آيبان',
  newAdvance:'+ سلفة / قرض جديد', advanceStatus:'الحالة', pending:'معلق',
  repaid:'مسدد', deductedFromSalary:'خصم من الراتب', addAdvance:'إضافة سلفة',
  employee:'الموظف', overLimit:'تجاوز الحد', currentOutstanding:'المستحق الحالي',
  editLimit:'تعديل الحد', creditLimits:'حدود ائتمان العملاء',
  creditLimitsDesc:'حدد الحد الأقصى للائتمان لكل عميل. سيحذرك النظام إذا تجاوز المستحق هذا الحد.',
  supplierStatement:'كشوفات الموردين', supplierStatementsDesc:'أرصدة الموردين وسجل المدفوعات.',
  multiBranch:'نظرة متعددة الفروع', multiBranchDesc:'مقارنة الأداء عبر جميع الفروع.',
  ...
  cashBalance:'رصيد الصندوق', bankBal:'رصيد البنك', investorNet:'صافي المستثمرين',
  cashIn:'وارد صندوق', cashOut:'صادر صندوق', allTypes:'جميع الأنواع',
  cashInType:'وارد صندوق', cashOutType:'صادر صندوق', bankInType:'وارد بنك',
  bankOutType:'صادر بنك', investorInType:'وارد مستثمر', investorOutType:'صادر مستثمر',
  ...
  searchEmployees:'بحث في الموظفين...', totalExpenses:'إجمالي المصروفات', count:'العدد',
  totalRefunds:'إجمالي الاسترجاعات', refundedToCustomers:'المسترجع للعملاء',
  refundedToPortals:'المسترجع للبوابات', totalPortals:'إجمالي البوابات',
  depositNote:'مثل: إيداع مبيعات الصندوق اليومية في البنك',
  prevBooking:'الحجز السابق / الرصيد المستحق', availableStoreCredit:'الرصيد المستحق المتاح',
  linkPreviousRefund:'ربط استرجاع سابق', noLinkedBooking:'— لا يوجد حجز مربوط —',
  oldTicket:'التذكرة القديمة', originalPrice:'السعر الأصلي', refundedToCustomer:'المسترجع للعميل',
  companyKept:'احتفظت به الشركة', linkedReason:'السبب',
  invoiceDesign:'تصميم الفاتورة', professionalInvoice:'فاتورة احترافية',
  refundNo:'رقم الاسترجاع', custRefund:'استرجاع العميل', portalRefund:'استرجاع البوابة',
  originalInv:'الفاتورة الأصلية', noRefunds:'لا توجد استرجاعات',
  clickRefund:'اضغط على زر الاسترجاع في أي فاتورة لإنشاء واحدة!',
  transferNote:'ملاحظة', rows:'صفوف', showing:'عرض', of:'من',
  prev:'السابق', next:'التالي', noData:'لا توجد بيانات', backToDashboard:'العودة للوحة',
  pageUnderDev:'الصفحة قيد التطوير', totalPaid:'المدفوع', totalDue:'المتبقي',
  totalProfit:'الربح', unpaidInvoices:'فواتير غير مدفوعة', netProfit:'صافي الربح',
  portalBalances:'أرصدة البوابات', quickActions:'إجراءات سريعة',
  recentInvoices:'الفواتير الأخيرة', invDate:'تاريخ الفاتورة', airlineCol:'خط الطيران',
  serviceCol:'الخدمة', statusCol:'الحالة', actionsCol:'إجراءات',
  addPassengerBtn:'+ إضافة راكب', passengerName:'اسم الراكب',
  ...
  locationCol:'الموقع', managerCol:'المدير', emailCol:'البريد', timingCol:'المواعيد',
  salaryCol:'الراتب', commissionCol:'نسبة العمولة %', iqamaCol:'الإقامة',
  titleCol:'العنوان', expiryCol:'انتهاء الصلاحية', maktabCol:'مكتب العمل',
  dateCol:'التاريخ', typeCol:'النوع', descCol:'الوصف',
  paymentCol:'الدفع', amountCol:'المبلغ',
  fromCol:'من', toCol:'إلى', noteCol:'ملاحظة',
  dateTypeCol:'التاريخ/الوقت', userCol:'المستخدم', actionCol:'الإجراء',
  emailCol:'البريد', usernameCol:'اسم المستخدم', linkedEmpCol:'الموظف المربوط',
  permsCol:'الصلاحيات', nameCol:'الاسم', phoneCol:'الهاتف',
  balanceCol:'الرصيد', currentOutstandingCol:'المستحق الحالي',
  limitCol:'حد الائتمان', actionCol:'الإجراء',
  vendorCol:'المورد', phoneCol:'الهاتف', balanceDueCol:'الرصيد المستحق',
  empCol:'الموظف', dateCol:'التاريخ', amountCol:'المبلغ', statusCol:'الحالة',
  actionCol:'الإجراءات', branchName:'اسم الفرع', branchManager:'المدير',
  ...
  storeCreditMsg:'متاح',
  exceedsMsg:'⚠️ يتجاوز الرصيد المتاح',
  useMaxBtn:'استخدم الحد الأقصى المتاح',
  reqDateCol:'التاريخ', custRefundCol:'استرجاع العميل', portalRefundCol:'استرجاع البوابة',
  origInvCol:'الفاتورة الأصلية', reasonCol:'السبب',
  refundToCustCol:'المسترجع للعملاء', refundToPortCol:'المسترجع للبوابات',
  refundCountCol:'إجمالي الاسترجاعات',
  expenseDateCol:'التاريخ', expenseTypeCol:'النوع', expenseDescCol:'الوصف',
  expensePaymentCol:'الدفع',
  cashInCol:'وارد صندوق', cashOutCol:'صادر صندوق',
  bankInCol:'وارد بنك', bankOutCol:'صادر بنك', investorInCol:'وارد مستثمر',
  investorOutCol:'صادر مستثمر',
  transTypeCol:'النوع', transDescCol:'الوصف', transAmountCol:'المبلغ',
  totalExpAmtCol:'إجمالي المصروفات', expCountCol:'العدد',
  totalPortalsCol:'إجمالي البوابات', portalNameCol:'الاسم',
  portalTypeCol:'النوع', portalBalCol:'الرصيد',
  pkgNameCol:'الاسم', pkgPriceCol:'السعر', pkgDurationCol:'المدة', pkgInclusionsCol:'يشمل',
  branchNameCol:'الاسم', branchLocCol:'الموقع', branchPhoneCol:'الهاتف',
  branchMgrCol:'المدير', branchEmailCol:'البريد', branchTimingCol:'المواعيد',
  hrNameCol:'الاسم', hrRoleCol:'الدور', hrPhoneCol:'الهاتف',
  hrSalaryCol:'الراتب', hrCommCol:'نسبة العمولة %', hrIqamaCol:'الإقامة',
  userEmpCol:'الموظف المربوط', userPermsCol:'الصلاحيات',
  permAdmin:'مدير', permInvoices:'الفواتير', permBank:'البنك',
  permHR:'الموارد البشرية', permReports:'التقارير', permSettings:'الإعدادات',
  emailDisabled:'(لا يمكن تغييره)', createBtn:'+ إنشاء فاتورة',
  noInvoicesMsg:'لا توجد فواتير بعد. أنشئ أول فاتورة!',
  noRefundsMsg:'لا توجد استرجاعات. اضغط على زر الاسترجاع في أي فاتورة لإنشاء واحدة!',
  noCustomersMsg:'لا يوجد عملاء.', noCorporatesMsg:'لا توجد شركات.',
  noVendorsMsg:'لا يوجد موردون.', noCreditorsMsg:'لا يوجد دائنون.',
  noPortalsMsg:'لا توجد بوابات.', noPackagesMsg:'لا توجد باقات.',
  noBranchesMsg:'لا توجد فروع.', noEmployeesMsg:'لا يوجد موظفون.',
  noExpensesMsg:'لا توجد مصروفات.', noLogsMsg:'لا توجد سجلات.',
  noUsersMsg:'لا يوجد مستخدمون.', noMistakesMsg:'لا توجد أخطاء مسجلة بعد.',
  noAdvancesMsg:'لا توجد سلف معلقة.', noPayrollMsg:'لم يتم دفع رواتب بعد.',
  noAttMsg:'لا توجد سجلات حضور بعد.',
  noPortalsBalMsg:'لم تتم إضافة بوابات بعد.',
  ...
  paidLabel:'مدفوع', dueLabel:'متبقي',
  ...
  corporateRole:'شركة',
  serviceRole:'الخدمة',
  flightTicketRole:'تذكرة طيران',
  hotelRole:'فندق',
  visaRole:'تأشيرة',
  packageRole:'باقة',
  otherRole:'أخرى',
  flightTypeRole:'نوع الرحلة',
  domesticRole:'داخلي',
  internationalRole:'دولي',
  journeyRole:'الرحلة',
  singleRole:'اتجاه واحد',
  returnRole:'ذهاب وعودة',
  multiCityRole:'مدن متعددة',
  bookingTypeRole:'نوع الحجز',
  newBookingRole:'حجز جديد',
  reissueRole:'إعادة إصدار',
  dateChangeRole:'تغيير التاريخ',
  voidRole:'إلغاء',
  paymentRole:'طريقة الدفع',
  cashRole:'نقداً',
  bankTransferRole:'تحويل بنكي',
  cardRole:'بطاقة',
  creditRole:'آجل',
  creditBalanceRole:'رصيد مستحق',
  tabbyRole:'تابي',
  tamaraRole:'تمارة',
  ticketStatusRole:'حالة التذكرة',
  confirmedRole:'مؤكد',
  onHoldRole:'معلق',
  cancelledRole:'ملغي',
  refundableRole:'قابل للاسترجاع',
  nonRefundableRole:'غير قابل للاسترجاع',
  visaTypeRole:'نوع التأشيرة',
  touristRole:'سياحية',
  businessRole:'أعمال',
  workRole:'عمل',
  transitRole:'عبور',
  leaveTypeRole:'نوع الإجازة',
  annualRole:'سنوية',
  sickRole:'مرضية',
  emergencyRole:'طوارئ',
  unpaidLeaveRole:'بدون راتب',
  advanceStatusRole:'حالة السلفة',
  pendingRole:'معلق',
  repaidRole:'مسدد',
  deductedFromSalaryRole:'خصم من الراتب',
  expenseApprovalRole:'اعتماد المصروفات',
  approvalStatusRole:'حالة الاعتماد',
  approvedRole:'موافق عليه',
  rejectedRole:'مرفوض',
  activeRole:'نشط',
  suspendedRole:'معلق',
  paidRole:'مدفوع',
  unpaidRole:'غير مدفوع',
  draftRole:'مسودة',
  recurringRole:'متكرر',
  recurringIntervalRole:'الفترة',
  monthlyRole:'شهرياً',
  yearlyRole:'سنوياً',
  weeklyRole:'أسبوعياً',
  customerRole:'العميل',
  amountRole:'المبلغ (ريال)',
  intervalRole:'الفترة',
  profilePicRole:'تحديث صورة الملف الشخصي',
  usernameRole:'اسم المستخدم',
  phoneNumberRole:'رقم الهاتف',
  addressFieldRole:'العنوان',
  saveProfileBtn:'💾 حفظ تغييرات الملف الشخصي',
  changePasswordTitle:'🔒 الأمان',
  newPasswordRole:'كلمة المرور الجديدة',
  ...
  crNoLabel:'الرقم التجاري',
  phoneLabel:'الهاتف',
  addressLabel:'العنوان',
  activeStatus:'✅ نشط',
  suspendedStatus:'❌ معلق',
  profitabilityTitle:'📊 محلل ربححية التذاكررة',
  profitabilityDesc:'تحليل أي الخطوط أو الخدمات التي تولد أكبر ربح.',
  airlineServiceCol:'الخط / الخدمة',
  ticketsSoldCol:'التذاكر المباعة',
  totalRevCol:'إجمالي الإيرادات',
  totalCostCol:'إجمالي التكلفة',
  netProfitCol:'صافي الربح',
  noInvoiceData:'لا توجد بيانات فواتير. أنشئ فواتير لرؤية تحليل الربحية.',
  ...
  customerRefundCol:'استرجاع العميل',
  officeEarned:'ربح المكتب',
  customerStatementTitle:'📊 كشف عميل',
  selectCustomerLabel:'اختر عميل لعرض الكشف',
  selectCustomerPlaceholder:'اختر العميل',
  transactionHistory:'سجل المعاملات',
  txnDateCol:'التاريخ',
  txnInvNoCol:'رقم الفاتورة',
  txnDebitCol:'مدين (الفاتورة)',
  txnCreditCol:'ائتمان (مدفوع)',
  txnBalanceCol:'الرصيد',
  downloadStatementBtn:'تحميل الكشف',
  noTxnFound:'لا توجد معاملات.',
  ...
  createBtn:'إنشاء',
  profileIdCol:'معرف الملف',
  intervalCol:'الفترة',
  amountCol:'المبلغ',
  noRecurringProfiles:'لا توجد ملفات متكررة.',
  expenseApprovalTitle:'🛡️ نظام اعتماد المصروفات',
  ...
  staffMitsakesTitle:'⚠️ تتبع أخطاء الموظفين والخسائر',
  ...
  quoteNoCol:'رقم العرض',
  quoteServiceCol:'الخدمة',
  quoteAmountCol:'المبلغ',
  quoteActionCol:'الإجراء',
  convertToInvoiceBtn:'تحويل إلى فاتورة',
  noQuotations:'لا توجد عروض أسعار.',
  hrAdvancedTitle:'🎯 أهداف وأداء الموظفين',
  targetCol:'الهدف (ريال)',
  achievedCol:'المحقق (ريال)',
  percentageCol:'النسبة',
  saveBtn:'حفظ',
  editBtn2:'تعديل',
  ...
  checkInCol:'تسجيل الحضور',
  checkOutCol:'تسجيل الانصراف',
  overtimeCol:'إضافي',
  deductionCol:'خصم',
  noAttendanceHistory:'لم يتم تسجيل حضور بعد.',
  paySalaryTitle:'💰 دفع الراتب',
  paySalaryDesc:'اختر موظف لملء الراتب الأساسي والسلف المعلقة تلقائياً. العمولة والوقت الإضافي ستُحسب تلقائياً من المبيعات والحضور.',
  baseCol:'الأساسي',
  advDedCol:'خصم سلفة',
  giftCol:'هدية',
  monthCol:'الشهر',
  ...
  corporateContractTitle:'📄 مولد عقد الشركات',
