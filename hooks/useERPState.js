...
// ==========================================
// PREMIUM HIGH-TECH INVOICE TEMPLATE (DEEP DETAILS)
// ==========================================
  ...
  <head>
    ...
    <style>
      * { box-sizing: border-box; -webkit-print-color-adjust: exact; print-color-adjust: exact; margin: 0; padding: 0; }
      ...
      .reissue-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 15px; }
      .reissue-item { background: #fff; padding: 15px; border-radius: 8px; border: 1px solid #fde68a; }
      .reissue-item .lbl { font-size: 11px; color: #92400e; font-weight: 600; text-transform: uppercase; }
      .reissue-item .val { font-size: 14px; color: #78350f; font-weight: 700; margin-top: 5px; }
      .reissue-credit { background: #dcfce7; border-color: #86efac; }
      .reissue-credit .lbl { color: #059669; }
      .reissue-credit .val { color: #047857; font-size: 18px; font-weight: 800; }
    ...
    <div class="invoice-box">
      ...
      <div class="body">
        <div class="details-grid">
          ...
          <div class="info-block" style="border-left-color: #f59e0b;">
            <div class="bilingual-title"><span>NEW FLIGHT DETAILS / تفاصيل الرحلة الجديدة</span></div>
        ...
        <div class="reissue-block">
          ...
          <div class="reissue-grid">
            <div class="reissue-item"><div class="lbl">تاريخ الحجز القديم / Old Invoice Date</div><div class="val">${inv.old_booking_date || 'N/A'}</div></div>
            <div class="reissue-item"><div class="lbl">سبب الاسترجاع / Refund Reason</div><div class="val">${inv.refund_reason || 'N/A'}</div></div>
            ...
            <div class="reissue-item"><div class="lbl">رقم الحجز القديم / Original PNR</div><div class="val">${inv.old_pnr || 'N/A'}</div></div>
            <div class="reissue-item"><div class="lbl">التذكرة القديمة / Original Ticket No</div><div class="val">${inv.old_ticket_no || 'N/A'}</div></div>
            <div class="reissue-item"><div class="lbl">نوع الرحلة القديمة / Original Flight Type</div><div class="val">${inv.old_flight_type || 'N/A'}</div></div>
            <div class="reissue-item"><div class="lbl">طريقة الدفع القديمة / Original Payment</div><div class="val">${inv.old_payment_method || 'N/A'}</div></div>
            <div class="reissue-item"><div class="lbl">الركاب القدامى / Original Passengers</div><div class="val">${inv.old_passengers || 'N/A'}</div></div>
            <div class="reissue-item reissue-credit"><div class="lbl">سعر البيع الأصلي / Original Selling Price</div><div class="val">${parseFloat(inv.old_sell_price || 0).toFixed(2)} SAR</div></div>
            <div class="reissue-item reissue-credit" style="grid-column: span 2;"><div class="lbl">رصيد الاسترجاع المطبق / Refund Credit Applied</div><div class="val">- ${usedCredit.toFixed(2)} SAR</div></div>
          </div>
        </div>` : ''}
      ...
      <div class="footer">
        ...
        <div class="footer-text">
          <p style="font-size: 14px; color: #475569; font-weight: 600;">Thank you for choosing us! We look forward to serving you again.</p>
          <p style="font-size: 14px; color: #64748b; font-family: 'Cairo';">شكراً لاختياركم إيانا. نتطلع لخدمتكم مرة أخرى.</p>
        </div>
...
// ==========================================
// PREMIUM REFUND INVOICE TEMPLATE (DEEP DETAILS)
// ==========================================
    ...
    <div class="invoice-box">
      ...
      <div class="body">
        <div class="info-block">
          ...
          <div class="row"><span class="label">الركاب / Passengers</span><span class="value">${inv.passenger_names || 'N/A'}</span></div>
          <div class="row"><span class="label">خط الطيران / Airline</span><span class="value">${inv.airline || 'N/A'}</span></div>
          <div class="row"><span class="label">القطاع / Sector</span><span class="value">${inv.flight_sector || inv.sector || 'N/A'}</span></div>
          ...
          <div class="row"><span class="label">التذكرة / Ticket No</span><span class="value">${inv.ticket_no || 'N/A'}</span></div>
          <div class="row"><span class="label">سبب الاسترجاع / Reason</span><span class="value">${inv.refund_reason || 'N/A'}</span></div>
        </div>
...
export default function useERPState() {
  ...
  // Added old_ fields for deep fetch
