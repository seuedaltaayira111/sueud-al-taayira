...
// Yeh function invoice ko WhatsApp par share karega
export const handleShareWhatsApp = (inv, settings) => {
  const phone = inv.customers?.phone || '';
  // Phone number se spaces aur + hatane ke liye
...
%0A
You can view your invoice online here: https://yourdomain.com/invoice/${inv.invoice_no}`;

  const url = `https://wa.me/${cleanPhone}?text=${msg}`;
  window.open(url, '_blank');
};

// Yeh function invoice ko Email par share karega
