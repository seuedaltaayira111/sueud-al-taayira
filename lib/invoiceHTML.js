...
<div class="inv">
<div class="hdr">
  <div class="ci"><div class="logo" style="display:flex;align-items:center;justify-content:center;font-size:24px">💰</div><div class="ct"><h2>${st.company_name_ar || 'صعود الطائرة'}</h2><h1>${st.company_name_en || 'SUEUD AL TAAYIRA'}</h1><p>${st.address_ar || ''} ${st.phone ? '| ' + st.phone : ''}</p></div></div>
...
<div class="ft">
  ...
  <div class="ft-divider"></div>
  <div class="ai-msg"><div class="ai-label">🤖 AI MESSAGE</div><p>${aiMsg}<span>${lang === 'ar' ? '📝 سند مصروفات معتمود' : 'Approved expense voucher'}</span></p></div>
  <div class="ft-divider"></div>
...
/* ═══════════════════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════
    style={{ fontSize: '48px', marginBottom: '20px', animation: 'spin 2s linear infinite' }}@keyframes spin{0%{transform:rotate(0deg)}100%{transform:rotate(360deg}}@keyframes pulse{0%,100%{opacity:0.4}50%{opacity:1}}'
    </style>
    <h3 style={{ margin: '0 0 10px', color: '#FBBF24', marginBottom: '10px' }}>💰 Salary Slip</h3>
    ...
    <form onSubmit={handlePaySalary} style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(120px, 1fr)', gap: '15px' }}>
      <div><label style={{ display: 'block', marginBottom: '5px', color: '#94A3B8', fontSize: '13px', fontWeight: '600' }}>Select Employee</label>
        <select name="emp" style={{ padding: '10px', border: '1px solid #334155', borderRadius: '6px', background: '#0F172A', color: '#E2E8F0', fontSize: '14px', outline: 'none' }} required>
          <option value="">Select Employee</option>
          {(data.employees || []).map(e => <option key={e.id} value={e.id}>{e.name}</option>)}
        </select>
      </div>
      <div><label style={{ display: 'block', marginBottom: '5px', color: '#94A3B8', fontSize: '13px', fontWeight: '600' }}>Base Salary</label>
        <input name="base" type="number" style={{ padding: '10px', border: '1px solid #334155', borderRadius: '6px', background: '#0F172A', color: '#E2E8F0', fontSize: '14px', outline: 'none' }} value={payForm.base} onChange={e => setPayForm(p => ({ ...p, base: e.target.value }))} required />
      </div>
      <div><label style={{ display: 'block', marginBottom: '5px', color: '#94A3B8', fontSize: '13px', fontWeight: '600' }}>Commission %</label>
        <input name="comm" type="number" style={{ padding: '10px', border: '1px solid #334155', borderRadius: '6px', background: '#0F172A', color: '#E2E8F0', fontSize: '14px', outline: 'none' }} value={payForm.comm} onChange={e => setPayForm(p => ({ ...p, comm: e.target.value }))} required />
      </div>
      <div><label style={{ display: 'block', marginBottom: '5px', color: '#94A3B8', fontSize: '13px', fontWeight: '600' }}>Adv. Deduct</label>
        <input name="adv_ded" type="number" style={{ padding: '10px', border: '1px solid #334155', borderRadius: '6px', background: '#0F172A', color: '#E2E8F0', fontSize: '14px', outline: 'none' }} value={payForm.adv_ded} onChange={e => setPayForm(p => ({ ...p, adv_ded: e.target.value }))} required />
      </div>
      <div><label style={{ display: 'block', marginBottom: '5px', color: '94A3B8', fontSize: '13px', fontWeight: '600' }}>Gift</label>
        <input name="gift" type="number" style={{ padding: '10px', border: '1px solid #334155', borderRadius: '6px', background: '#0F172A', color: '#E2E8F0', fontSize: '14px', outline: 'none' }} value={payForm.gift} onChange={e => setPayForm(p => ({ ...p, gift: e.target.value }))} />
      </div>
      <div><label style={{ display: 'block', marginBottom: '5px', color: '#94A3B8', fontSize: '13px', fontWeight: '600' }}>Month</label>
        <input name="month" type="text" style={{ padding: '10px', border: '1px solid #334155', borderRadius: '6px', background: '#0F172A', color: '#E2E8F0', fontSize: '14px', outline: 'none' }} value={payForm.month} onChange={e => setPayForm(p => ({ ...p, month: e.target.value }))} required />
      </div>
      <div><label style={{ display: 'block', marginBottom: '5px', color: '#94A3B8', fontSize: '13px', fontWeight: '600' }}>Mode</label>
        <select name="mode" style={{ padding: '10px', border: '1px solid #334155', borderRadius: '6px', background: '#0F172A', color: '#E2E8F0', fontSize: '14px', outline: 'none' }} value={payForm.mode} onChange={e => setPayForm(p => ({ ...p, mode: e.target.value }))}><option>Cash</option><option>Bank Transfer</option></select>
      </div>
      <button type="submit" style={{ padding: '10px 15px', background: 'linear-gradient(135deg, #1E3A8A, #2563EB)', color: '#fff', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold', fontSize: '14px' }}>Pay</button>
    </form>
        </div>
        <div style={{ background: 'white', borderRadius: '12px', overflow: 'hidden', boxShadow: '0 4px 6px rgba(0,0,0.05)', marginBottom: '20px' }}>
          <div style={{ padding: '20px', borderBottom: '1px solid #E2E8F0' }}><h3 style={{ margin: '0 0 10px', color: '#0F172A' }}>📋 Generate Salary Slip</h3></div>
          <div style={{ overflowX: 'auto' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: '600px' }}>
              <thead><tr>
                <th style={{ padding: '12px', background: '#0F172A', color: '#FBBF24', textAlign: 'left', fontSize: '13px' }}>Employee</th>
                <th style={{ padding: '12px', background: '#0F172A', color: '#FBBF24', textAlign: 'right', fontSize: '13px' }}>Month</th>
                <th style={{ padding: '12px', background: '#0F172A', color: '#FBBF24', textAlign: 'right', fontSize: '13px' }}>Net Paid</th>
                <th style={{ padding: '12px', background: '#0F172A', color: '#FBBF24', textAlign: 'center', fontSize: '13px' }}>Action</th>
              </tr></thead>
              <tbody>
                {data.payroll.length === 0 ? <tr><td colSpan="4" style={{ padding: '30px', textAlign: 'center', color: '#94A3B8' }}>No salary paid yet.</td></tr> : data.payroll.map(p => (
                  <tr key={p.id} style={{ borderBottom: '1px solid #1E293B' }}>
                    <td style={{ fontWeight: 'bold' }}>{p.employees?.name || 'N/A'}</td>
                    <td>{p.month}</td>
                    <td style={{ color: '#059669', fontWeight: 'bold' }}>{(p.amount || 0).toFixed(2)} SAR</td>
                    <td style={{ textAlign: 'center' }}>
                      <button onClick={() => handleGenerateSlip(p)} style={{ padding: '6px 12px', background: '#1E3A8A', color: '#93C5FD', border: 'none', borderRadius: '6px', cursor: 'pointer', fontSize: '12px' }}>Preview Slip</button>
                      <button onClick={() => handleDeletePayroll(p)} style={{ padding: '6px 12px', background: '#EF4444', color: '#FECACA', border: 'none', borderRadius: '6px', cursor: 'pointer', fontSize: '12px', marginLeft: '5px' }}>Delete</button>
                    </td>
                  </tr>
                ))}
              </tbody>
...
/* ═════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════
      style={{ padding: '10px 12px', background: '#1E3A8A', color: '#FBBF24', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold', fontSize: '14px' }}>Preview Slip</button>
      </div>
      <div style={{ background: 'white', borderRadius: '12px', overflow: 'hidden', boxShadow: '0 4px 6px rgba(0,0,0,0.05)', marginBottom: '20px' }}>
        <div style={{ padding: '20px', borderBottom: '1px solid #E2E8F0' }}><h3 style={{ margin: '0 0 10px', color: '#0F172A' }}>⚠️ Staff Mistakes & Loss Tracking</h3></div>
        <div style={{ padding: '20px' }}>
          <form onSubmit={handleAddMistake} style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr)', gap: '15px', alignItems: 'flex-end' }}>
            <div><label style={{ display: 'block', marginBottom: '5px', color: '#94A3B8', fontSize: '13px', fontWeight: '600' }}>Employee</label>
              <select name="emp" style={{ padding: '10px', border: '1px solid #334155', borderRadius: '6px', background: '#0F172A', color: '#E2E8F0', fontSize: '14px', outline: 'none' }} required>
                <option value="">Select Employee</option>
                {(data.employees || []).map(e => <option key={e.id} value={e.id}>{e.name}</option>)
              </select>
            </div>
            <div><label style={{ display: 'block', marginBottom: '5px', color: '#94A3B8', fontSize: '13px', fontWeight: '600' }}>Old Ticket No</label>
              <input name="old_tkt" style={{ padding: '10px', border: '1px solid #334155', borderRadius: '6px', background: '#0F172A', color: '#E2E8F0', fontSize: '14px', outline: 'none' }} placeholder="Old Ticket No" required />
            </div>
            <div><label style={{ display: 'block', marginBottom: '5px', color: '#94A3B8', fontSize: '13px', fontWeight: '600' }}>New Ticket No</label>
              <input name="new_tkt" style={{ padding: '10px', border: '1px solid #334155', borderRadius: '6px', background: '#0F172A', color: '#E2E8F0', fontSize: '14px', outline: 'none' }} placeholder="New Ticket No" required />
            </div>
            <div><label style={{ display: 'block', marginBottom: '5px', color: '#94A3B8', fontSize: '13px', fontWeight: '600' }}>Loss Amount (SAR)</label>
              <input name="loss_amt" type="number" step="0.01" style={{ padding: '10px', border: '1px solid #334155', borderRadius: '6px', background: '#0F172A', color: '#E2E8F0', fontSize: '14px', outline: 'none' }} placeholder="Loss Amount" required />
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
              <label style={{ display: 'flex', alignItems: 'center', gap: '5px', cursor: 'pointer', marginBottom: '10px' }}>
                <input type="checkbox" name="paid_by_emp" />
                <span style={{ fontSize: '13px', color: '#94A3B8' }}>Deduct from Salary</span>
              </label>
              <button type="submit" style={{ background: 'linear-gradient(135deg, #1E3A8A, #2563EB)', color: '#fff', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold', fontSize: '14px', height: '42px' }}>Log Loss</button>
            </div>
          </form>
        </div>
        <div style={{ background: 'white', borderRadius: '12px', overflow: 'hidden', boxShadow: '0 4px 6px rgba(0,0,0,0.05)' }}>
          <div style={{ padding: '20px', borderBottom: '1px solid #E2E8F0' }}><h3 style={{ margin: '0 0 10px', color: '#0F172A' }}>Mistake History</h3></div>
          <div style={{ overflowX: 'auto' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: '800px' }}>
              <thead><tr><th style={{ padding: '12px', background: '#0F172A', color: '#FBBF24', textAlign: 'left', fontSize: '13px' }}>Date</th><th style={{ padding: '12px', background: '#0F172A', color: '#FBBF24', textAlign: 'left' }}>Employee</th><th style={{ padding: '12px', background: '#0F172A', color: '#FBBF24', textAlign: 'left' }}>Old Ticket</th><th style={{ padding: '12px', background: '#0F172A', color: '#FBBF24', textAlign: 'center' }}>New Ticket</th><th style={{ padding: '12px', background: '#0F172A', color: '#FBBF24', textAlign: 'right' }}>Loss Amount</th><th style={{ padding: '12px', background: '#0F172A', color: '#FBBF24', textAlign: 'center' }}>Salary Deducted</th></tr></thead>
              <tbody>
                {data.staffMistakes.length === 0 ? <tr><td colSpan="6" style={{ padding: '30px', textAlign: 'center', color: '#94A3B8' }}>No mistakes logged yet.</td></tr> : data.staffMistakes.map(m => (
                  <tr key={m.id} style={{ borderBottom: '1px solid #1E293B', background: '#FFFBEB' }}>
                    <td style={{ fontSize: '12px' }}>{m.date}</td>
                    <td style={{ fontSize: '12px' }}>{m.employees?.name || 'N/A'}</td>
                    <td style={{ fontSize: '12px' }}>{m.old_ticket_no}</td>
                    <td style={{ fontSize: '12px' }}>{m.new_ticket_no}</td>
                    <td style={{ fontSize: '12px', fontWeight: 'bold', color: '#EF4444' }}>{(m.loss_amount || 0).toFixed(2)} SAR</td>
                    <td style={{ fontSize: '12px' }}>
                      <span style={{ padding: '4px 10px', borderRadius: '12px', fontSize: '11px', fontWeight: 'bold', color: m.paid_by_employee ? '#059669' : '#64748B', background: m.paid_by_employee ? '#D1FAE5D' : '#F1F5F9F' }}>Yes</span>
                    </td>
                  </tr>
                ))}
              </tbody>
...
/* ═════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════
      style={{ padding: '10px 12px', background: '#1E3A8A', color: '#FBBF24', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold', fontSize: '12px', marginLeft: '5px' }}>Preview Voucher</button>
    </div>
      </div>
  </div>
};
...
/* ═════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════
      style={{ padding: '10px 12px', background: '#1E3A8A', color: '#FBBF24', border: 'none', borderRadius: '8px', cursor: 'pointer', fontSize: '12px', marginLeft: '5px' }}>Delete</button>
    </div>
  </div>
</div>`;
