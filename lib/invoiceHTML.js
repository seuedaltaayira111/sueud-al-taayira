...
// ================================================================
// 1. SALES INVOICE (PREMIUM FULL-PAGE)
// ================================================================
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; -webkit-print-color-adjust: exact; print-color-adjust: exact; margin: 0; padding: 0; }
    ...
    /* PREVIOUS BOOKING / REFUND (if exists) */
    .linked-section {
      margin-top: 4px;
      padding-top: 8px;
...
<div class="invoice-container">
  ...
  <div class="body">
    ...
    <div class="info-grid">
      <div class="info-box">
        <div class="section-title" style="border-bottom-color:#1E3A8A;">BILL TO / فاتورة إلى</div>
      ...
      <div class="info-box gold">
        <div class="section-title" style="border-bottom-color:#F59E0B;">FLIGHT DETAILS / تفاصيل الرحلة</div>
    ...
    <div class="bottom-section">
      <div class="payment-breakdown">
        <div class="section-title" style="border-bottom-color:#1E3A8A;">PAYMENT BREAKDOWN / تفصيل الدفع</div>
...
// ================================================================
// 2. REFUND INVOICE (PREMIUM FULL-PAGE)
// ================================================================
...
// ================================================================
// 3. EXPENSE VOUCHER (PREMIUM FULL-PAGE)
// ================================================================
...
// ================================================================
// 4. SALARY SLIP (PREMIUM FULL-PAGE)
// ================================================================
...
// ================================================================
// 6. MISTAKE VOUCHER (PREMIUM FULL-PAGE)
// ================================================================
...
<div class="mistake-container">
  <div class="header">
    ...
    <div class="header-right">
      ...
      <div class="meta">Date: <span>${m.date || today}</span></div>
...
// ================================================================
// 7. RECHARGE VOUCHER (PREMIUM FULL-PAGE)
// ================================================================
