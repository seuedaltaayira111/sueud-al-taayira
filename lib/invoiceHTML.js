...
/* ================================================================
   INVOICE HTML GENERATORS - BILINGUAL (EN/AR) - BIG QR & FOOTER
   QR Code size: 200x200, Footer enlarged
   ================================================================ */
...
// ================================================================
// 1. SALES INVOICE - PERMANENTLY BILINGUAL, BIG QR, BIG FOOTER
// ================================================================
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; -webkit-print-color-adjust: exact; print-color-adjust: exact; margin: 0; padding: 0; }
    ...
    .code-section img { height: 40px; width: auto; border-radius: 4px; border: 1px solid #E2E8F0; padding: 2px 6px; background: #FFF; }
    .code-section .qr { height: 64px; width: 64px; }
    .code-label { font-size: 8px; text-align: center; color: #64748B; font-weight: 600; }
    .ai-message {
      flex: 1;
      text-align: center;
      padding: 6px 14px;
    ...
    .ai-message .ai-label { font-size: 8px; color: #3B82F6; font-weight: 700; text-transform: uppercase; }
    .ai-message p { font-size: 10px; color: #1E3A8A; margin: 0; }
    .footer-info { text-align: center; min-width: 70px; }
    .footer-info p { font-size: 9px; color: #94A3B8; margin: 2px 0; }
    .footer-info .name { font-weight: 700; color: #0F172A; font-size: 10px; }
    .linked-section {
      margin-top: 4px;
      padding-top: 8px;
...
// ================================================================
// 2. REFUND INVOICE - PERMANENTLY BILINGUAL, BIG QR, BIG FOOTER
// ================================================================
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; -webkit-print-color-adjust: exact; print-color-adjust: exact; margin: 0; padding: 0; }
    ...
    .footer { padding: 14px 24px; background: #FEF2F2; border-top: 1px solid #FECACA; display: flex; justify-content: space-between; align-items: center; flex-shrink: 0; margin-top: auto; gap: 16px; }
    .code-section { display: flex; align-items: center; gap: 10px; }
    .code-section img { height: 40px; width: auto; border-radius: 4px; border: 1px solid #FECACA; padding: 2px 6px; background: #FFF; }
    .code-section .qr { height: 64px; width: 64px; }
    .code-label { font-size: 8px; text-align: center; color: #991B1B; font-weight: 600; }
    .ai-message { flex: 1; text-align: center; padding: 6px 14px; background: #FEF2F2; border-radius: 6px; border: 1px solid #FCA5A5; }
    .ai-message .ai-label { font-size: 8px; color: #DC2626; font-weight: 700; text-transform: uppercase; }
    .ai-message p { font-size: 10px; color: #7F1D1D; margin: 0; }
    .footer-info { text-align: center; min-width: 70px; }
    .footer-info p { font-size: 9px; color: #94A3B8; margin: 2px 0; }
    .footer-info .name { font-weight: 700; color: #7F1D1D; font-size: 10px; }
...
// ================================================================
// 3. EXPENSE VOUCHER - PERMANENTLY BILINGUAL, BIG QR, BIG FOOTER
// ================================================================
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; -webkit-print-color-adjust: exact; print-color-adjust: exact; margin: 0; padding: 0; }
    ...
    .footer { padding: 14px 24px; background: #FFF7ED; border-top: 1px solid #FED7AA; display: flex; justify-content: space-between; align-items: center; flex-shrink: 0; margin-top: auto; gap: 16px; }
    .code-section { display: flex; align-items: center; gap: 10px; }
    .code-section img { height: 40px; width: auto; border-radius: 4px; border: 1px solid #FED7AA; padding: 2px 6px; background: #FFF; }
    .code-section .qr { height: 64px; width: 64px; }
    .code-label { font-size: 8px; text-align: center; color: #7C2D12; font-weight: 600; }
    .ai-message { flex: 1; text-align: center; padding: 6px 14px; background: #FFF7ED; border-radius: 6px; border: 1px solid #FDBA74; }
    .ai-message .ai-label { font-size: 8px; color: #9A3412; font-weight: 700; text-transform: uppercase; }
    .ai-message p { font-size: 10px; color: #7C2D12; margin: 0; }
    .footer-info { text-align: center; min-width: 70px; }
    .footer-info p { font-size: 9px; color: #94A3B8; margin: 2px 0; }
    .footer-info .name { font-weight: 700; color: #7C2D12; font-size: 10px; }
...
// ================================================================
// 4. SALARY SLIP - PERMANENTLY BILINGUAL, BIG QR, BIG FOOTER
// ================================================================
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; -webkit-print-color-adjust: exact; print-color-adjust: exact; margin: 0; padding: 0; }
    ...
    .footer { padding: 14px 24px; background: #EFF6FF; border-top: 1px solid #BFDBFE; display: flex; justify-content: space-between; align-items: center; flex-shrink: 0; margin-top: auto; gap: 16px; }
    .code-section { display: flex; align-items: center; gap: 10px; }
    .code-section img { height: 40px; width: auto; border-radius: 4px; border: 1px solid #BFDBFE; padding: 2px 6px; background: #FFF; }
    .code-section .qr { height: 64px; width: 64px; }
    .code-label { font-size: 8px; text-align: center; color: #1E3A8A; font-weight: 600; }
    .ai-message { flex: 1; text-align: center; padding: 6px 14px; background: #EFF6FF; border-radius: 6px; border: 1px solid #93C5FD; }
    .ai-message .ai-label { font-size: 8px; color: #3B82F6; font-weight: 700; text-transform: uppercase; }
    .ai-message p { font-size: 10px; color: #1E3A8A; margin: 0; }
    .footer-info { text-align: center; min-width: 70px; }
    .footer-info p { font-size: 9px; color: #94A3B8; margin: 2px 0; }
...
// ================================================================
// 5. CONTRACT - PERMANENTLY BILINGUAL, BIG QR, BIG FOOTER
// ================================================================
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; -webkit-print-color-adjust: exact; print-color-adjust: exact; margin: 0; padding: 0; }
    ...
    .footer { padding: 14px 24px; background: #F8FAFC; border-top: 1px solid #E2E8F0; display: flex; justify-content: space-between; align-items: center; flex-shrink: 0; margin-top: auto; gap: 16px; font-size: 9px; color: #64748B; }
    .code-section { display: flex; align-items: center; gap: 10px; }
    .code-section img { height: 40px; width: auto; border-radius: 4px; border: 1px solid #E2E8F0; padding: 2px 6px; background: #FFF; }
    .code-section .qr { height: 64px; width: 64px; }
    .code-label { font-size: 8px; text-align: center; color: #475569; font-weight: 600; }
...
// ================================================================
// 6. MISTAKE VOUCHER - PERMANENTLY BILINGUAL, BIG QR, BIG FOOTER
// ================================================================
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; -webkit-print-color-adjust: exact; print-color-adjust: exact; margin: 0; padding: 0; }
    ...
    .footer { padding: 14px 24px; background: #FEF2F2; border-top: 1px solid #FECACA; display: flex; justify-content: space-between; align-items: center; flex-shrink: 0; margin-top: auto; gap: 16px; font-size: 9px; color: #64748B; }
...
// ================================================================
// 7. RECHARGE VOUCHER - PERMANENTLY BILINGUAL, BIG QR, BIG FOOTER
// ================================================================
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; -webkit-print-color-adjust: exact; print-color-adjust: exact; margin: 0; padding: 0; }
    ...
    .total-box .amount { font-size: 18px; font-weight: 900; color: #FBBF24; }
    .footer { padding: 14px 24px; background: #F8FAFC; border-top: 1px solid #E2E8F0; display: flex; justify-content: space-between; align-items: center; flex-shrink: 0; margin-top: auto; gap: 16px; font-size: 9px; color: #94A3B8; }
    .footer p { margin: 0; font-size: 10px; }
