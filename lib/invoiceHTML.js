...
/* ================================================================
   ...
   Full page fill + Previous Booking + Refund on same invoice
   Store Credit system
...
/* ================================================================
   SALES INVOICE HTML - MODERN DESIGN
   ================================================================ */
  ...
  <style>
    ...
    * { box-sizing: border-box; -webkit-print-color-adjust: exact; print-color-adjust: exact; margin: 0; padding: 0; }
    ...
    @media print {
      ...
      .invoice-container { border-radius: 0; box-shadow: none; width: 100%; min-height: 100vh; max-height: none; }
    }
  </style>
</head>
<body>
  ...
  <div class="linked-section">
    ...
    <div class="refund-details">
      ...
      <div class="refund-grid">
        <div class="item">
          <div class="label">${isRTL ? 'المبلغ المسترد' : 'Refund Amount'}</div>
          <div class="value">${(inv.refund_customer || 0).toFixed(2)} SAR</div>
        </div>
        <div class="item">
          <div class="label">${isRTL ? 'تاريخ الاسترجاع' : 'Refund Date'}</div>
          <div class="value">${inv.refund_date || inv.invoice_date || 'N/A'}</div>
        </div>
        <div class="item">
          <div class="label">${isRTL ? 'السبب' : 'Reason'}</div>
...
/* ================================================================
   REFUND INVOICE HTML - MODERN DESIGN
   ================================================================ */
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; -webkit-print-color-adjust: exact; print-color-adjust: exact; margin: 0; padding: 0; }
    ...
    @media print {
      body { background: white; padding: 0; margin: 0; }
      .recharge-container { border-radius: 0; box-shadow: none; width: 100%; min-height: 100vh; }
    }
  </style>
</head>
<body>
